...
const team = [
  {
    ...
    bio: "20 years shaping the Lagos skyline. Formerly at Foster + Partners. His focus is on sustainable tropical modernism."
  },
  {
    id: "02",
    name: "Chioma Nwosu",
    ...
    bio: "Specialist in structural integrity for high-humidity coastal zones. She ensures what we build stands for generations."
  },
  {
    id: "03",
    name: "David Ibrahim",
    ...
    bio: "The bridge between the drawing board and the site. Precision from the first pour to the final handover."
  },
  {
    id: "04",
    name: "Sarah Johnson",
    ...
    bio: "Crafting silence and space within the concrete shell. Focusing on the acoustics and light of the lived experience."
  }
];
              ...
              <div className="flex items-center justify-between py-8 px-2 md:px-4">
                <div className="flex items-center gap-8 md:gap-16">
                  <span className={cn(
                    ...
                    isActive ? "text-black/50" : "text-white/50"
                  )}>
                    {member.id}
                  </span>
                  <h3 className={cn(
                ...
                <div className="flex items-center gap-8">
                  ...
                  <div className="relative w-4 h-4">
                    ...
                    <span className={cn(
                      "absolute top-1/2 left-0 w-full h-[1px] transform -translate-y-1/2 transition-colors duration-500",
                      isActive ? "bg-black" : "bg-white"
                    )} />
                    {/* Vertical Line - Rotates & Adapts color */}
                    <span className={cn(
                      "absolute top-0 left-1/2 h-full w-[1px] transform -translate-x-1/2 transition-all duration-300",
                      isActive ? "bg-black rotate-90" : "bg-white rotate-0"
                    )} />
                  </div>
                </div>
              </div>
                ...
                <div className="md:col-span-6 flex flex-col justify-between h-full text-white">
                  ...
                  <div className="mt-8 md:mt-0 pt-8 border-t border-black/10 flex gap-8">
                     <div>
                        ...
                        <span className="block text-sm font-medium text-white">M.Arch, UCL London</span>
                     </div>
                     <div>
                        <span className="block text-[10px] uppercase text-white mb-1">Experience</span>
                        <span className="block text-sm font-medium text-white">22 Years</span>
                     </div>
                  </div>
                </div>
              </div>
